...
export default function Hero() {
  return (
    <section className="flex flex-col items-start gap-m" aria-labelledby="hero-title" role="region">
        ...
        <div className="flex gap-s">
          <Button text="Contact me" link='/contact' type="primary" ariaLabel="Go to Contact page"/>
        </div>
    </section>
  )
}
